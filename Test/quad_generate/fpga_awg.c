...
int fpga_awg_init(void)
{
    ...
    g_osc_reg = (uint32_t *)g_awg_reg -
        (OSC_OFFSET / sizeof(uint32_t)); // This offset s subtracted since OSC comes before the AWG in the address map
