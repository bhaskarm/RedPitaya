...
static const scpi_command_t scpi_commands[] = {
    ...
    {.pattern = "SOUR#:BUF#:FREQ:FIX", .callback             = RP_GenFrequency,},
    {.pattern = "SOUR#:BUF#:FREQ:FIX?", .callback            = RP_GenFrequencyQ,},
    {.pattern = "SOUR#:BUF#:FUNC", .callback                 = RP_GenWaveForm,},
    {.pattern = "SOUR#:BUF#:FUNC?", .callback                = RP_GenWaveFormQ,},
    {.pattern = "SOUR#:BUF#:VOLT", .callback                 = RP_GenAmplitude,},
    {.pattern = "SOUR#:BUF#:VOLT?", .callback                = RP_GenAmplitudeQ,},
    {.pattern = "SOUR#:BUF#:VOLT:OFFS", .callback            = RP_GenOffset,},
    {.pattern = "SOUR#:BUF#:VOLT:OFFS?", .callback           = RP_GenOffsetQ,},
    {.pattern = "SOUR#:BUF#:PHAS", .callback                 = RP_GenPhase,},
    {.pattern = "SOUR#:BUF#:PHAS?", .callback                = RP_GenPhaseQ,},
    {.pattern = "SOUR#:BUF#:DCYC", .callback                 = RP_GenDutyCycle,},
    ...
    {.pattern = "SOUR#:BUF#:BURS:INT:PER?", .callback        = RP_GenBurstPeriodQ,},
