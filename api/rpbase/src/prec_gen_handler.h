...
int prec_gen_setWaveform(rp_channel_t channel, int buf_idx, rp_waveform_t type);
int prec_gen_getWaveform(rp_channel_t channel, int buf_idx, rp_waveform_t *type);
...
int prec_synthesize_signal(rp_channel_t channel);
